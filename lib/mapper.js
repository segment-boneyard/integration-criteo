...
exports.track = function(track) {
  // XXX(ndhoule): This is a temporary hack. integration-worker uses
  // an old version of facade and this integration relies on methods
  // found only in a newer version, so we re-facade messages here to
  // prevent errors
  track = new Track(track.obj, track.opts);
